...
scaler_model_1 = pickle.load(open("models/scaler_1.pkl", 'rb'))
pca_model_1 = pickle.load(open("models/pca_1.pkl", 'rb'))
logistic_model_1 = pickle.load(open("models/tuned_logistic_regression_model_1.pkl", 'rb'))
scaler_model = pickle.load(open("models/scaler.pkl", 'rb'))
pca_model = pickle.load(open("models/pca.pkl", 'rb'))
logistic_model = pickle.load(open("models/tuned_logistic_regression_model.pkl", 'rb'))

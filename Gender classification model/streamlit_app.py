...
scaler_model = pickle.load(open("models/scaler_1.pkl", 'rb'))
pca_model = pickle.load(open("models/pca_1.pkl", 'rb'))
logistic_model = pickle.load(open("models/tuned_logistic_regression_model_1.pkl", 'rb'))
